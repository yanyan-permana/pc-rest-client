            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= site_url('kelas/insert') ?>" method="post">
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama</label>
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukan nama kelas" value="<?php echo set_value('nama'); ?>">
                                <?php if ($error_nama != '') : ?>
